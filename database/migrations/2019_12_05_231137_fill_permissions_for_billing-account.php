...
class FillPermissionsForBillingAccount extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBillingAccount constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.billing-account.index',
            'admin.billing-account.create',
            'admin.billing-account.show',
            'admin.billing-account.edit',
            'admin.billing-account.delete',
        ]);
