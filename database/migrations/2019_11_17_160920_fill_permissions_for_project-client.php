...
class FillPermissionsForProjectClient extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProjectClient constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.project-client.index',
            'admin.project-client.create',
            'admin.project-client.show',
            'admin.project-client.edit',
            'admin.project-client.delete',
        ]);
