...
class FillPermissionsForStockEntry extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForStockEntry constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.stock-entry',
            'admin.stock-entry.index',
            'admin.stock-entry.create',
            'admin.stock-entry.show',
            'admin.stock-entry.edit',
            'admin.stock-entry.delete',
        ]);
