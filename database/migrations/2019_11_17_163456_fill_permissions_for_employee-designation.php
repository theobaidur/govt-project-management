...
class FillPermissionsForEmployeeDesignation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEmployeeDesignation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.employee-designation.index',
            'admin.employee-designation.create',
            'admin.employee-designation.show',
            'admin.employee-designation.edit',
            'admin.employee-designation.delete',
        ]);
