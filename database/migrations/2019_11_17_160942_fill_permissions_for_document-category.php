...
class FillPermissionsForDocumentCategory extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDocumentCategory constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.document-category.index',
            'admin.document-category.create',
            'admin.document-category.show',
            'admin.document-category.edit',
            'admin.document-category.delete',
        ]);
